...
namespace ZeroTier.Mappers
{
    public static class NetworkMapper
    {
        ...
        {
            PermissionsViewModel permissionsViewModel = viewModel.Permissions ?? new PermissionsViewModel();
            PermissionsDto permissionsDto = PermissionsToDto(permissionsViewModel) ?? new PermissionsDto();

            UserInterfaceSettingsViewModel uiViewModel = viewModel.Ui ?? new UserInterfaceSettingsViewModel();
            UserInterfaceSettingsDto uiDto = UiToDto(uiViewModel) ?? new UserInterfaceSettingsDto();
